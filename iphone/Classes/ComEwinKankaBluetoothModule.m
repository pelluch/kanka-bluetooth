...
- (void) deviceConnected:(iGrillBLEDevice*)device
{
    ...
    if(onConnect) {
        ...
        (@"Registering data updated observer");
...
{
    // (@"Checking for undiscovered devices");
